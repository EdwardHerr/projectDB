              ...
              <div className="col-sm-4 mb-5" key={key} >
                <div className='card h-100 text-center' >
                  ...
                  <div className="card-footer bg-transparent">
                      <a className='mx-3' href="#" id={item.id} onClick={handleDetailsClick} >Details</a>
                      <a className='btn btn-primary mx-3' id={item.id} href="#" onClick={handleAddToCartClick}>Add to Cart</a>
                  </div>
                </div>
              </div>
            ))}
